...
使用 serverless devs 将 fc-chatyuan 部署到阿里云函数计算上

</description>

<codeUrl>

- [:smiley_cat: 代码](https://github.com/devsapp/fc-chatyuan)
...
```bash
IMAGE="registry.cn-hangzhou.aliyuncs.com/fc-demo2/ohyee-test:fc-chatyuan-v1"
cd src/code/server/
